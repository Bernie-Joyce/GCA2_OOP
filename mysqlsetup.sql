...
VALUES (1, 'Emma', 'Murphy', 30, '12 Maple Street, Dublin, Ireland', '+353 86 123 ', 'emma.murphy@email.ie'),
...
INSERT INTO `cats` (`Id`, `OwnerID`, `Name`, `Gender`, `Breed`, `DateOfBirth`, `Color`, `IdentifyingMarkings`)
VALUES (1, 1, 'Luna', 'Female', 'Maine Coon', '2026-02-24 13:48:47', 'Brown tabby',
        'White chest patch and tufted ears'),
       (2, 2, 'Oliver', 'Male', 'British Shorthair', '2026-02-24 13:48:48', 'Blue (gray)',
        'Small white spot on left paw'),
       (3, 3, 'Bella', 'Female', 'Siamese', '2026-02-24 13:48:48', 'Seal point',
        'Dark facial mask and darker tail tip'),
       (4, 4, 'Leo', 'Male', 'Bengal', '2026-02-24 13:48:48', 'Golden with black ro',
        'Distinct large rosette pattern on sides'),
       (5, 5, 'Nala', 'Female', 'Ragdoll', '2026-02-24 13:48:48', 'Cream and light gray',
        'White blaze on nose and white front socks'),
       (6, 1, 'Milo', 'Male', 'Persian', '2026-02-24 13:48:49', 'White', 'Flat face with tear staining under eyes'),
       (7, 2, 'Chloe', 'Female', 'Scottish Fold', '2026-02-24 13:48:50', 'Gray tabby',
        'Folded ears and white chin patch'),
       (8, 3, 'Simba', 'Male', 'Abyssinian', '2026-02-24 13:48:51', 'Ruddy', 'Dark dorsal stripe along back'),
       (9, 4, 'Cleo', 'Female', 'Sphynx', '2026-02-24 13:48:52', 'Pinkish gray',
        'Wrinkled skin and darker nose bridge'),
       (10, 5, 'Oscar', 'Male', 'Norwegian Forest Cat', '2026-02-24 13:48:53', 'Brown and white',
        'Thick ruff around neck and white back paws');

INSERT INTO `nutrition` (`CatId`, `DailyCaloriesKcal`, `ProteinGrams`, `FatGrams`, `CarbGrams`, `WaterIntakeMl`,
                         `MealsPerDay`, `FoodBrand`, `DietaryRestrictions`)
VALUES (1, 350, 45.5, 18.3, 12.0, 250, 2, 'Royal Canin', 'Grain-free'),
